...
const SignUp = () => {
  ...
  return (
    <div style={{display:'flex', justifyContent:'center',alignItems:'center'}}>
      ...
      <h2 className='abhaya-libre-bold'>Join Us Today!</h2>
      <input type="text" name="Name" id="name" placeholder='Enter Your Name' style={{width:'520px', height:'40px', border:'1px solid black', borderRadius:'20px', paddingLeft:'20px',marginBottom:'20px'}}/>
      ...
      <input type="text" name="Name" id="name" placeholder='Enter Your Mobile Number' style={{width:'520px', height:'40px', border:'1px solid black', borderRadius:'20px', paddingLeft:'20px',marginBottom:'20px'}}/>
      <button style={{width:'150px', height:'50px', backgroundColor:'white', border:'1px solid black', marginBottom:'20px'}}>Generate OTP</button>
